<template>
<div class="content" :style='{"minHeight":"100vh","padding":"20px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231022/30183857b9844112ade95e282459e4ba.png) no-repeat center top / cover","display":"flex","fontSize":"14px","height":"auto"}'>
	<!-- notice -->
	<!-- title -->
	<div class="text" :style='{"margin":"0px auto 40px","color":"rgb(51, 51, 51)","textAlign":"center","display":"none","width":"100%","fontSize":"32px","fontWeight":"600"}'>欢迎使用 {{this.$project.projectName}}</div>
	

	<!-- 日历 -->
	<div class="calendar" :style='{"border":"0px solid #bababa","boxShadow":"0 1px 0px rgba(0,0,0,0.12), 0 1px 1px rgba(0,0,0,0.24)","margin":"0px auto 30px 2%","borderRadius":"0px","color":"#737373","background":"none","width":"calc(49% - 0px)","fontSize":"inherit","height":"auto","order":"1"}'>
	  <div :style='{"padding":"9px 7%","borderColor":"#ddd","color":"#fff","borderRadius":"0","flexWrap":"wrap","background":"#2196F3","borderWidth":"0 0 0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}'>
	    ...
	    <div :style='{"padding":"0 10px","fontSize":"18px","alignItems":"center","justifyContent":"center","display":"flex"}'>
	  ...
	  <table :style='{"border":"0px solid #eee","width":"100%","padding":"0px","borderRadius":"0px","background":"rgba(255, 255, 255, .96)","height":"auto"}' v-if="this.weeks.length">
	    <thead :style='{"width":"100%","height":"auto"}'>
	      <tr :style='{"borderColor":"#eee","alignItems":"center","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"center"}'>
	        <th :style='{"alignItems":"center","color":"inherit","flex":1,"display":"flex","lineHeight":"30px","fontSize":"inherit","justifyContent":"center"}' v-for="item,index in this.heads" :key="index">{{item}}</th>
	      </tr>
	    </thead>
	    <tbody :style='{"width":"100%"}'>
	      <tr :style='{"width":"100%","alignItems":"center","justifyContent":"center","display":"flex"}' v-for="week,index in this.weeks" :key="index">
	        <td :style='{"cursor":"pointer","padding":"4px 12px 4px","flex":1,"display":"flex","height":"auto"}' v-for="day,key in week.days" :key="key" :class="{other: day.isOther, festival: day.isFestival, today: day.isToday, rest: day.isRest}">
	          <div class="text">
