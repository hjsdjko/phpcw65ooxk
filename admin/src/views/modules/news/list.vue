		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #bababa","padding":"0","boxShadow":"0 1px 0px rgba(0,0,0,0.12), 0 1px 1px rgba(0,0,0,0.24)","margin":"10px 0 0","borderRadius":"0px","background":"rgba(255,255,255,1)","width":"100%"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="headportrait" width="200" label="头像">
						<template slot-scope="scope">
							<div v-if="scope.row.headportrait">
								<img v-if="scope.row.headportrait.substring(0,4)=='http'" :src="scope.row.headportrait.split(',')[0]" width="100" height="100">
								<img v-else :src="$base.url+scope.row.headportrait.split(',')[0]" width="100" height="100">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
